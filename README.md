...
You can also call the functions to generate message traffic from the console. Acknowledgements will be used based on the checkbox setting.
```
testmsg(msg)
